(() => {
  ...
  // V6 no longer depends on dozens of pokeapi.co requests.
  ...
  function getActiveBlockPartition(bytes, begin, length) {
    // Gen IV block detection compares two uint32 counters beginning 0x14 bytes
    // before the end of each block. The first is the major counter and the
    // second is the minor counter. Higher counter = newer block.
